                ...
                <div className="flex items-center gap-3 text-base">
                  {(product as any).rating > 0 && (
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="font-montserrat font-semibold text-luxury-navy">{((product as any).rating as number).toFixed(1)}</span>
                    </div>
                  )}
                  {(product as any).rating > 0 && (product as any).products_sold > 0 && (
                  ...
                  {(product as any).products_sold > 0 && (
                    <span className="font-montserrat text-gray-500 text-sm tracking-wide">
