...
const carouselImages = [
  '/assets/carousel3/id-11134210-8224s-mgon1iycy4ng64.webp',
  '/assets/carousel3/id-11134210-8224s-mgon1iyczj7wa1.webp',
  '/assets/carousel3/id-11134210-8224s-mgon1iyd3qx8cb.webp',
  '/assets/carousel3/id-11134210-8224s-mgon1iycvbik4b.webp'
]

export function ImageCarousel3() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-[#A8C5D6] to-[#8FB3C9] py-8 md:py-12 lg:py-16">
          ...
          <AnimatePresence initial={false} custom={direction} mode="wait">
            ...
            >
              <Image
                ...
                alt={`Carousel 3 image ${currentIndex + 1}`}
                width={1200}
                height={600}
