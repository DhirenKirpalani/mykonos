...
const carouselImages = [
  '/assets/carousel4/id-11134210-7ra0p-mcd5kvkur8sndb.webp',
  '/assets/carousel4/id-11134210-81ztm-megmwrhgodtv87.webp',
  '/assets/carousel4/id-11134210-8224o-mgon1iydj7646c.webp',
  '/assets/carousel4/id-11134210-8224p-mgon1iyd55ho97.webp',
  '/assets/carousel4/id-11134210-7ra0j-mckhobqivdw7c9.webp',
  '/assets/carousel4/id-11134210-7ra0j-mcd5kvkuofrt3c.webp'
]

export function ImageCarousel4() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-[#E6C9C9] to-[#D4B3B3] py-8 md:py-12 lg:py-16">
          ...
          <AnimatePresence initial={false} custom={direction} mode="wait">
            ...
            >
              <Image
                ...
                alt={`Carousel 4 image ${currentIndex + 1}`}
                width={1200}
                height={600}
