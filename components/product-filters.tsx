...
const categories = ['All Products', 'Fragrance Families']
              ...
              <div className="space-y-2">
                ...
                <div>
                  <button
                    ...
                    className={`flex w-full items-center justify-between rounded-lg px-4 py-2.5 text-left text-sm font-medium transition-all ${
                      fragranceFamilies.includes(currentCategory || '')
                        ? 'bg-[#C2A36B] text-white shadow-sm'
                        : 'bg-gray-50 text-gray-700 hover:bg-gray-100'
                    }`}
                  >
                        ...
                        <button
                          ...
                          className={`block w-full rounded-lg px-4 py-2 text-left text-sm transition-all ${
                            currentCategory === family
                              ? 'bg-[#C2A36B]/20 text-[#C2A36B] font-medium'
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none rounded-lg border border-[#C2A36B]/30 bg-gradient-to-br from-white to-[#F8F6F3] px-4 py-3 pr-10 text-sm font-medium text-[#1C2E4A] shadow-sm transition-all hover:border-[#C2A36B] focus:border-[#C2A36B] focus:outline-none focus:ring-2 focus:ring-[#C2A36B]/20 cursor-pointer"
                >
                ...
                <ChevronDown className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#C2A36B]" />
              </div>
            </div>
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none rounded-lg border border-[#C2A36B]/30 bg-gradient-to-br from-white to-[#F8F6F3] px-4 py-3 pr-10 text-sm font-medium text-[#1C2E4A] shadow-sm transition-all hover:border-[#C2A36B] hover:shadow-md focus:border-[#C2A36B] focus:outline-none focus:ring-2 focus:ring-[#C2A36B]/20 cursor-pointer"
            >
              {sortOptions.map((option) => (
                <option key={option.value} value={option.value}>
                  {option.label}
