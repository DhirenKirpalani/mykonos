export const translations = {
  en: {
    ...
    home: {
      ...
      forMen: "Men's Collection",
      forWomen: "Women's Collection",
      forUnisex: "Unisex Collection",
      forMenTab: "Men",
      forWomenTab: "Women",
      forUnisexTab: "Unisex",
    ...
    about: {
      ...
      artPara1: "Founded in 2019, MYKONOS is an Indonesian perfume house born from a passion for sensory storytelling and the transformative art of modern alchemy.",
      artPara2: "We are architects of contemporary scent, constantly moving at the speed of culture to capture the zeitgeist of global trends. By keeping our finger firmly on the pulse of the international fragrance market, we identify the world's most coveted, trendiest notes and completely reinvent them. We don't just react to trends, we masterfully twist them, infusing cutting-edge innovation into every bottle to create bold, unexpected compositions that challenge the ordinary. Our devotion to innovation lives in our proprietary creations. Alongside global trends, you will discover exclusive, custom accords developed entirely in-house by the MYKONOS team, such as our signature Blue Java Banana accord and our crisp, comforting Coconut Linen accord.",
      craftsmanship: "Rapid Global Expansion",
      craftPara1: "Starting from our roots in Indonesia, MYKONOS has embarked on an explosive journey to share our unique olfactive visions with the world. In just one single year, our strategic partnerships and strong brand momentum have fueled a rapid expansion into 12 countries across the globe.",
      craftPara2: "By bringing our creations to an international audience, this unprecedented growth marks a thrilling new chapter in our mission to become a definitive, globally recognized leader in the modern fragrance industry.",
      sustainability: "Our Philosophy",
      sustainPara1: "At the core of MYKONOS is a refusal to compromise. We marry striking, premium packaging with ultra-luxurious, high performance fragrances designed to linger and captivate. Our philosophy is simple:",
      sustainPara2: "We create for the bold, the curious, and those who appreciate true artistry. With every release, we invite you to expect the unexpected, allowing your nose to be surprised as we take you on an evocative, boundary-pushing journey of experiences.",
  ...
  id: {
    ...
    footer: {
      ...
      returnPolicy: "Kebijakan Pengembalian Dana",
    ...
    home: {
      ...
      forMen: "Koleksi Pria",
      forWomen: "Koleksi Wanita",
      forUnisex: "Koleksi Unisex",
      forMenTab: "Pria",
      forWomenTab: "Wanita",
      forUnisexTab: "Unisex",
    ...
    about: {
      ...
      artPara1: "Didirikan pada tahun 2019, MYKONOS adalah rumah parfum Indonesia yang lahir dari hasrat untuk penceritaan sensoris dan seni transformasi alkimia modern.",
      artPara2: "Kami adalah arsitek aroma kontemporer yang terus bergerak seiring perkembangan budaya untuk menangkap semangat tren global. Dengan tetap merasakan denyut pasar parfum internasional, kami mengidentifikasi nada-nada paling dicari dan treniest di dunia serta mengubahnya sepenuhnya. Kami tidak sekadar bereaksi terhadap tren, kami memutarnya dengan mahir, menyuntikkan inovasi mutakhir ke dalam setiap botol untuk menciptakan komposisi berani dan tak terduga yang menantang kebiasaan. Devosi kami terhadap inovasi hidup dalam kreasi eksklusif kami. Di samping tren global, Anda akan menemukan akord kustom eksklusif yang dikembangkan sepenuhnya di dalam rumah oleh tim MYKONOS, seperti akord tanda tangan Blue Java Banana kami dan akord Coconut Linen yang segar dan menenangkan.",
      craftsmanship: "Ekspansi Global Pesat",
      craftPara1: "Berangkat dari akar kami di Indonesia, MYKONOS telah memulai perjalanan eksplosif untuk membagikan visi olfaktif unik kami kepada dunia. Hanya dalam satu tahun, kemitraan strategis dan momentum merek yang kuat telah mendorong ekspansi pesat ke 12 negara di seluruh dunia.",
      craftPara2: "Dengan membawa kreasi kami ke khalayak internasional, pertumbuhan yang belum pernah terjadi sebelumnya ini menandai babak baru yang menarik dalam misi kami untuk menjadi pemimpin definitif dan diakui secara global dalam industri parfum modern.",
      sustainability: "Filosofi Kami",
      sustainPara1: "Inti dari MYKONOS adalah penolakan untuk berkompromi. Kami memadukan kemasan premium yang mencolok dengan parfum ultra-mewah dan berkinerja tinggi yang dirancang untuk bertahan dan memukau. Filosofi kami sederhana:",
      sustainPara2: "Kami menciptakan untuk yang berani, yang ingin tahu, dan yang menghargai seni sejati. Dengan setiap peluncuran, kami mengajak Anda untuk mengharapkan yang tak terduga, membiarkan hidung Anda terkejut saat kami membawa Anda dalam perjalanan pengalaman yang menggugah dan mendorong batas.",
