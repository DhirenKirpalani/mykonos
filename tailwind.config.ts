...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['var(--font-lato)', 'Gill Sans', 'Gill Sans MT', 'sans-serif'],
        serif: ['var(--font-caslon)', 'Georgia', 'serif'],
        heading: ['var(--font-caslon)', 'Georgia', 'serif'],
        caslon: ['var(--font-caslon)', 'Georgia', 'serif'],
        lato: ['var(--font-lato)', 'Gill Sans', 'sans-serif'],
        futura: ['Futura PT', 'sans-serif'],
        montserrat: ['var(--font-montserrat)', 'sans-serif'],
        playfair: ['Adobe Caslon Pro', 'var(--font-caslon)', 'Libre Caslon Text', 'Georgia', 'serif'],
